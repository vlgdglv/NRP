...
from data import TokenDataset, JanusImageRowCollator
from model.janus_full import load_janus_full, JanusFullModel
...
def train(args):
    ...
    run_name = args.run_name or f"janus_full_{args.epochs}ep_{args.batch_size}bs_{args.learning_rate}lr"
    output_dir = os.path.join(args.output_dir, run_name)
    os.makedirs(output_dir, exist_ok=True)

    base_model = load_janus_full(
...
if __name__ == "__main__":
    ...
    parser.add_argument("--checkpoint_path", type=str, default=None, help="Resume from a full checkpoint")
    ...
    parser.add_argument("--output_dir", type=str, default="training_outputs/janus_full")
    ...
    parser.add_argument("--image_width", type=int, default=24)
    parser.add_argument("--image_height", type=int, default=24)
