...
ßUDA_VISIBLE_DEVICES=4,5,6,7 deepspeed --master_port 12345  train.py  --deepspeed config/ds_config_zero3.json --batch_size 1 --epochs 5 --losses ce  --block_size 48 --lora_rank 32 --run_name rk32_lm_ce_b48_e5_bs1  --enable_wandb