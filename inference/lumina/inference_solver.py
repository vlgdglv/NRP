# Copied from https://github.com/Alpha-VLLM/Lumina-mGPT/blob/main/lumina_mgpt/inference_solver.py
...
class FlexARInferenceSolver:
    ...
    def get_args_parser(cls):
        parser = argparse.ArgumentParser("FlexARInference", add_help=False)
    ...
    def create_logits_processor(self, cfg=3.0, image_top_k=2000, text_top_k=10):
        ...
        if not self.inbatch_cfg:
            print("Not doing inbatch cfg")
